...
pub const APP_NAME: &str = "Threepole Custom";
pub const CONFIG_DIR_NAME: &str = "threepole-custom";
...
pub const NAMED_PIPE: &str = r"\\.\pipe\threepole-custom-open";
pub const USER_AGENT: &str = concat!("threepole-custom/", env!("CARGO_PKG_VERSION"));
